...
/* ✅ FIXED: Navigation - Scrollable with flex: 1 */
.sidebar-nav {
  flex: 1 1 0;
  min-height: 0;
  overflow-y: auto;
...
/* Dark mode support - already built in via parent classes */
/* The sidebar uses dark: classes in the main aside element */
</style>