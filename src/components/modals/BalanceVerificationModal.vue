...
// FIX: Remove unused inventoryStore and warehouseStore
...
// FIX: Remove unused warehouseName computed
...
const fetchItemData = async () => {
  try {
    ...
    if (data) {
      ...
      // Get last transaction in same query using join
...
const loadVerification = async () => {
  ...
  try {
    ...
    // FIX: Remove unused itemData variable
