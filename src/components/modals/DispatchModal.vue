      ...
      <div class="p-6 space-y-5 overflow-y-auto max-h-[calc(90vh-140px)]">
        ...
        <div>
          ...
          >
            ...
            <option v-for="w in dispatchWarehouses" :key="w.id" :value="w.id">
              {{ w.name_ar || w.name }}
            </option>
          </select>
        </div>
        ...
        <div>
          ...
          <input
            ...
            class="w-full px-4 py-2 border border-gray-300 rounded-lg mb-3 focus:ring-2 focus:ring-green-500 focus:border-transparent"
            :disabled="!sourceWarehouseId"
          />
            ...
            >
              <div class="flex justify-between items-start">
                ...
                <div class="text-right">
                  <div class="text-lg font-bold text-green-600">{{ item.remainingQuantity }}</div>
        ...
        <div v-if="selectedItem">
          ...
          <div class="flex items-center gap-3">
            ...
            <input
              ...
              class="flex-1 text-center text-xl font-bold py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
            />
            <button
