  ...
  <div :dir="languageStore.isRTL ? 'rtl' : 'ltr'" class="w-full px-2 sm:px-4 py-3 sm:py-6 pb-20">
    ...
    <div v-else>
      ...
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
        ...
        <div class="flex gap-2 w-full sm:w-auto">
          <button 
            ...
            class="flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white rounded-xl transition-all inline-flex items-center justify-center gap-1.5 shadow-md font-bold text-xs sm:text-sm min-h-[44px]"
          >
          ...
          <button 
            ...
            class="flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl transition-all inline-flex items-center justify-center gap-1.5 shadow-md font-bold text-xs sm:text-sm min-h-[44px]"
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-1.5 sm:gap-2 mb-3">
        ...
        <div class="bg-gradient-to-br from-gray-500 to-gray-600 rounded-lg shadow p-1.5 sm:p-2 text-white overflow-hidden">
      ...
      <div v-if="activeForm === 'manager'" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden mb-3">
        <div class="px-3 sm:px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20">
        ...
        <form @submit.prevent="createWarehouseManager" class="p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <div>
              ...
              <input type="text" v-model="warehouseManagerForm.name" required class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 dark:focus:ring-purple-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[40px]" placeholder="أدخل اسم مدير المستودع" />
            </div>
            <div>
              <label class="block text-gray-700 dark:text-gray-300 font-semibold mb-0.5 text-xs sm:text-sm">
                البريد الإلكتروني <span class="text-red-500">*</span>
              </label>
              <input type="email" v-model="warehouseManagerForm.email" required class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 dark:focus:ring-purple-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[40px]" placeholder="example@company.com" />
            </div>
          </div>
          ...
          <div>
            ...
            <input type="password" v-model="warehouseManagerForm.password" required class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 dark:focus:ring-purple-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[40px]" placeholder="كلمة مرور مؤقتة للمستخدم" />
          ...
          <div>
            ...
            <select v-model="warehouseManagerForm.allowedWarehouses" multiple class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 dark:focus:ring-purple-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[80px]" size="3">
          ...
          <div>
            ...
            <select v-model="warehouseManagerForm.allowedDispatchWarehouses" multiple class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 dark:focus:ring-purple-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[80px]" size="3">
          ...
          <div class="flex justify-end">
            <button type="submit" :disabled="isCreating" class="px-5 py-2 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white rounded-lg font-semibold transition-all shadow-md disabled:opacity-50 text-sm min-h-[40px] flex items-center gap-2">
      ...
      <div v-if="activeForm === 'viewer'" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden mb-3">
        <div class="px-3 sm:px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20">
        ...
        <form @submit.prevent="createViewer" class="p-3 sm:p-4 space-y-3">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <div>
              ...
              <input type="text" v-model="viewerForm.name" required class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[40px]" placeholder="أدخل اسم المستخدم" />
            </div>
            <div>
              <label class="block text-gray-700 dark:text-gray-300 font-semibold mb-0.5 text-xs sm:text-sm">
                البريد الإلكتروني <span class="text-red-500">*</span>
              </label>
              <input type="email" v-model="viewerForm.email" required class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[40px]" placeholder="viewer@company.com" />
            </div>
          </div>
          ...
          <div>
            ...
            <input type="password" v-model="viewerForm.password" required class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[40px]" placeholder="كلمة مرور مؤقتة للمستخدم" />
            <p class="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5">سيتمكن المستخدم من تغيير كلمة المرور بعد تسجيل الدخول</p>
          </div>
          ...
          <div>
            ...
            <select v-model="viewerForm.allowedWarehouses" multiple class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[80px]" size="3">
              <option v-for="warehouse in primaryWarehouses" :key="warehouse.id" :value="warehouse.id">
                {{ warehouse.name_ar || warehouse.name }}
              </option>
            </select>
          ...
          <div class="flex justify-end">
            <button type="submit" :disabled="isCreatingViewer" class="px-5 py-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg font-semibold transition-all shadow-md disabled:opacity-50 text-sm min-h-[40px] flex items-center gap-2">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-3 sm:p-4 mb-3">
        ...
        <div v-if="searchQuery" class="flex justify-between items-center text-xs text-gray-500 dark:text-gray-400 mb-2">
          ...
          <span v-if="filteredUsers.length === 0 && searchQuery.length >= 2 && !isSearching" class="text-green-600 dark:text-green-400">لا توجد نتائج مطابقة</span>
        </div>

        <!-- Filter Row -->
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
          <select v-model="filterRole" class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm font-medium min-h-[40px]">
          ...
          <select v-model="filterStatus" class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm font-medium min-h-[40px]">
            <option value="">جميع الحالات</option>
            <option value="active">نشط</option>
            <option value="inactive">غير نشط</option>
          </select>
          <button @click="resetFilters" class="px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm font-semibold text-gray-700 dark:text-gray-300 min-h-[40px]">
            إعادة تعيين
          </button>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
        <div class="px-3 sm:px-4 py-2 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <div>
          ...
          <span class="text-[10px] sm:text-xs font-bold bg-gray-100 dark:bg-gray-700 px-2.5 py-0.5 rounded-full self-start sm:self-auto">{{ filteredUsers.length }} مستخدم</span>
        </div>
          ...
          <table class="w-full min-w-[800px]">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              <tr v-for="user in filteredUsers" :key="user.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                ...
                <td class="px-3 sm:px-4 py-2.5">
                  <span :class="getRoleBadgeClass(user.role)" class="px-2 py-1 text-[10px] sm:text-xs font-medium rounded-full inline-block">
                ...
                <td class="px-3 sm:px-4 py-2.5">
                  <button @click="toggleUserStatus(user)" :class="user.is_active ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'" class="px-2 py-1 text-[10px] sm:text-xs font-medium rounded-full transition-colors min-h-[32px] min-w-[60px]">
        ...
        <div class="sm:hidden divide-y divide-gray-200 dark:divide-gray-700">
          <div v-for="user in filteredUsers" :key="user.id" class="p-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
            <div class="flex items-start justify-between mb-2">
              ...
              <span :class="getRoleBadgeClass(user.role)" class="px-2 py-1 text-[10px] font-medium rounded-full">
                {{ getRoleName(user.role) }}
              </span>
            </div>
            ...
            <div class="grid grid-cols-3 gap-1 text-xs mb-2">
              ...
              <div>
                ...
                <button @click="toggleUserStatus(user)" :class="user.is_active ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300'" class="px-2 py-0.5 text-[10px] font-medium rounded-full transition-colors min-h-[28px] min-w-[50px]">
                  {{ user.is_active ? 'نشط' : 'غير نشط' }}
                </button>
              </div>
            </div>
            ...
            <div class="flex gap-1.5">
              <button v-if="user.role === 'warehouse_manager' || user.role === 'viewer'" @click="editUserWarehouses(user)" class="flex-1 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs transition-colors flex items-center justify-center gap-1 min-h-[36px]">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
                صلاحيات
              </button>
              <button v-if="user.role !== 'superadmin' && user.id !== authStore.user?.id" @click="deleteUser(user)" class="flex-1 px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white rounded-lg text-xs transition-colors flex items-center justify-center gap-1 min-h-[36px]">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                </svg>
                حذف
      ...
      <div v-if="showEditWarehousesModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" @click.self="showEditWarehousesModal = false">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-4 sm:p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-gray-700">
          ...
          <div class="space-y-4">
            <div>
              ...
              <select v-model="editForm.allowedWarehouses" multiple class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 dark:focus:ring-purple-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[80px]" size="4">
            ...
            <div v-if="editingUser?.role === 'warehouse_manager'">
              ...
              <select v-model="editForm.allowedDispatchWarehouses" multiple class="w-full px-3 py-1.5 text-sm border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 dark:focus:ring-purple-800 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-h-[80px]" size="3">
          ...
          <div class="flex justify-end gap-3 mt-6">
            ...
            <button @click="updateUserWarehouses" :disabled="isUpdating" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors shadow-md text-sm min-h-[40px] flex items-center gap-2">
