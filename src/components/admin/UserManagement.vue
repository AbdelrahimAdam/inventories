    ...
    <div v-else class="user-management__content">
      ...
      <div class="users-section">
        <div class="users-section__header">
          <div class="users-section__title-wrapper">
      ...
      <!-- Add User Forms - Two Column Layout -->
      <div class="forms-grid">
        <!-- Add Warehouse Manager -->
        <div class="form-card form-card--purple">
          <div class="form-card__header">
            <div class="form-card__icon-wrapper">
              <svg class="form-card__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
            </div>
            <div>
              <h3 class="form-card__title">إضافة مدير مستودع</h3>
              <p class="form-card__subtitle">مدير يمكنه إدارة المخزون والصرف</p>
            </div>
          </div>

          <form @submit.prevent="createWarehouseManager" class="form-card__body">
        ...
        <!-- Add Viewer -->
        <div class="form-card form-card--blue">
          <div class="form-card__header">
            <div class="form-card__icon-wrapper">
              <svg class="form-card__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h3 class="form-card__title">إضافة مستخدم عرض فقط</h3>
              <p class="form-card__subtitle">يمكنه الاطلاع على البيانات فقط</p>
            </div>
          </div>

          <form @submit.prevent="createViewer" class="form-card__body">
            <div class="form-group">
              <label class="form-label">الاسم <span class="text-red-500">*</span></label>
              <input 
                type="text" 
...
.form-card--purple .form-card__header {
  background: linear-gradient(to right, #8b5cf6, #7c3aed);
}

.form-card--blue .form-card__header {
...
.form-card--purple .form-input:focus {
  border-color: #8b5cf6;
  box-shadow: 0 0 0 3px rgba(139, 92, 246, 0.2);
}

.form-card--blue .form-input:focus {
  border-color: #3b82f6;
  box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.2);
}
