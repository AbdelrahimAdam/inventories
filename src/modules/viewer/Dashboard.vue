<template>
  <div class="p-4 sm:p-6" :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
    <!-- ✅ SINGLE View-only Banner (removed duplicate) -->
...
// ✅ Get allowed warehouse IDs for the current user
...
const restrictedItems = computed(() => {
  ...
  // If no items or no allowed warehouses
  ...
  // Filter items to only allowed warehouses
...
// ✅ Transactions filtered by warehouse access
