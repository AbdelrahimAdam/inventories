    ...
    <div class="container mx-auto px-3 sm:px-4 py-4 sm:py-8 pb-20 md:pb-8">
      ...
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div class="flex flex-wrap gap-2 w-full sm:w-auto">
          ...
          <button @click="sendInvitations" class="flex-1 sm:flex-none bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white px-4 py-2.5 rounded-lg transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-sm">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
