<template>
  <div class="w-full pb-20" :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
    ...
    <!-- Loading Progress - Using store.loadingProgress like item list -->
...
async function loadDashboardData(force = false) {
  ...
  try {
    ...
    // ✅ Use fetchAllItemsForExport with progress tracking (same as item list)
    await inventoryStore.fetchAllItemsForExport({
      isFullLoad: true,
      onProgress: (loaded, total) => {
        // Calculate progress percentage like item list does
