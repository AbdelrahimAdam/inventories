<template>
  <div class="w-full pb-20" :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
    ...
    <!-- Stats Cards -->
    <div v-if="inventoryStore.items.length > 0 || dashboardStats.totalItems > 0" class="grid grid-cols-2 md:grid-cols-4 gap-1.5 sm:gap-2 mb-3">
