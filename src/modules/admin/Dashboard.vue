...
// Dashboard-specific state (separate from store)
...
// ✅ REMOVED: calculateStats function - not used, using dashboardStats instead
...
// ============================================
// ✅ FIXED: Dashboard loads ONLY stats + alerts + 50 items
// ============================================
async function loadDashboardData(force = false) {
  ...
  try {
    ...
    // ✅ Load stats from database (fast - aggregate query)
    ...
    // ✅ Load 50 items for the chart preview (if no items exist)
