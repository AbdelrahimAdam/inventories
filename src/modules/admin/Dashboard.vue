...
const showSkeleton = computed(() => {
  return isFirstLoad.value && (isLoadingStats.value || isLoadingItems.value)
})
...
const loadDashboardData = async () => {
  ...
  try {
    ...
    // Load all items into cache for accurate chart and alerts
...
const onWarehouseFilterChange = async () => {
  ...
  try {
    // Refetch items for the selected warehouse
    await inventoryStore.fetchItemsBulk(warehouseId)
