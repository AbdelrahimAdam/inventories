<template>
  <div class="w-full pb-20" :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
    ...
    <!-- Loading Progress - Show real-time progress -->
    ...
    <!-- Stats Cards - Show progressive data -->
    ...
    <!-- Inventory Distribution - Show when data is partially loaded -->
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-3 sm:p-4 mb-3">
      ...
      <!-- Show skeleton when loading but no data yet -->
      ...
      <!-- Show partial data when items are loading -->
    ...
    <!-- Warehouse Distribution - Progressive loading -->
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden mb-3">
      ...
      <div class="overflow-x-auto">
        <div class="max-h-[350px] overflow-y-auto">
          ...
          <!-- Show warehouse stats as they become available -->
          ...
          <!-- Empty state when no warehouse data -->
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-3 sm:p-4 mb-3">
      ...
      <div v-else-if="inventoryStore.items.length > 0" class="space-y-3 max-h-[450px] overflow-y-auto">
        ...
        <!-- Show loading indicator for alerts -->
...
const showSkeleton = computed(() => {
  return !dataInitialized.value && !inventoryStore.dataLoaded && !isLoadingData.value
})
...
const displayStats = computed(() => {
  ...
  // If inventory is loading but we have some items, calculate from what we have
...
async function loadDashboardData(force = false) {
  ...
  try {
    ...
    // Load items with progress tracking (the store handles batch loading)
