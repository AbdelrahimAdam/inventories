  ...
  <div class="w-full" :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-5 mb-4 border border-gray-200 dark:border-gray-700 shadow-sm">
      <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-col sm:flex-row gap-2">
          <select v-model="inventoryStore.currentFilters.warehouseId" class="w-full sm:w-auto px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-xl text-sm font-medium bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 min-h-[40px] sm:min-h-[44px]">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 sm:p-5 mb-4">
      ...
      <div v-else class="space-y-3 max-h-[450px] overflow-y-auto">
        ...
        <div v-if="criticalStockItemsList.length === 0 && lowStockItemsList.length === 0 && outOfStockItemsList.length === 0 && !isLoadingAlerts" class="text-center py-6 text-gray-500 font-bold">
