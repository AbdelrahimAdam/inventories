  ...
  <div class="space-y-6">
          ...
          <table class="w-full min-w-[600px]">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              <tr v-for="wh in warehouseStats" :key="wh.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                ...
                <td class="px-4 py-4 text-center text-base font-semibold text-gray-700 dark:text-gray-300">{{ formatNumber(wh.itemCount) }}</td>
                <td class="px-4 py-4 text-center font-bold text-gray-900 dark:text-white">{{ formatNumber(wh.totalUnits) }}</td>
                <td class="px-4 py-4 text-center"><span :class="wh.lowStockCount > 0 ? 'text-yellow-600 dark:text-yellow-400 font-bold' : 'text-gray-500 dark:text-gray-400'">{{ formatNumber(wh.lowStockCount) }}</span></td>
                <td class="px-4 py-4 text-center">
                  <div class="flex items-center justify-center gap-2">
                    <div class="w-24 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                      <div class="bg-amber-600 rounded-full h-2 transition-all duration-500" :style="{ width: wh.utilization + '%' }"></div>
                    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 sm:p-6">
        ...
        <div v-if="isLoadingAlerts" class="animate-pulse">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="flex flex-col items-center">
              <div class="relative w-20 h-20">
                <svg class="w-20 h-20 transform -rotate-90">
                  ...
                  <circle cx="40" cy="40" r="32" fill="none" stroke="#10b981" stroke-width="6" stroke-dasharray="201" :stroke-dashoffset="201 - (201 * inStockNum / 100)" />
                </svg>
            ...
            <div class="flex flex-col items-center">
              <div class="relative w-20 h-20">
                <svg class="w-20 h-20 transform -rotate-90">
                  <circle cx="40" cy="40" r="32" fill="none" stroke="#e5e7eb" stroke-width="6" />
                  <circle cx="40" cy="40" r="32" fill="none" stroke="#f97316" stroke-width="6" stroke-dasharray="201" :stroke-dashoffset="201 - (201 * criticalStockNum / 100)" />
                </svg>
                <div class="absolute inset-0 flex items-center justify-center">
            ...
            <div class="flex flex-col items-center">
              <div class="relative w-20 h-20">
                <svg class="w-20 h-20 transform -rotate-90">
                  <circle cx="40" cy="40" r="32" fill="none" stroke="#e5e7eb" stroke-width="6" />
                  <circle cx="40" cy="40" r="32" fill="none" stroke="#eab308" stroke-width="6" stroke-dasharray="201" :stroke-dashoffset="201 - (201 * lowStockNum / 100)" />
                </svg>
                <div class="absolute inset-0 flex items-center justify-center">
            ...
            <div class="flex flex-col items-center">
              <div class="relative w-20 h-20">
                <svg class="w-20 h-20 transform -rotate-90">
                  <circle cx="40" cy="40" r="32" fill="none" stroke="#e5e7eb" stroke-width="6" />
                  <circle cx="40" cy="40" r="32" fill="none" stroke="#ef4444" stroke-width="6" stroke-dasharray="201" :stroke-dashoffset="201 - (201 * outOfStockNum / 100)" />
                </svg>
                <div class="absolute inset-0 flex items-center justify-center">
          ...
          <div v-if="outOfStockItemsList.length > 0" class="p-3 rounded-lg border-r-4 border-red-500 bg-red-50/50 dark:bg-red-900/10">
            <div class="flex justify-between items-start">
              <div class="flex-1">
                ...
                <div v-if="outOfStockLoadMore > 5" class="text-center mt-2"><button @click="outOfStockLoadMore = 5" class="text-xs text-red-500 hover:text-red-700 underline">عرض أقل</button></div>
                <div v-else-if="outOfStockItemsList.length > 5" class="text-center mt-2"><button @click="outOfStockLoadMore = outOfStockItemsList.length" class="text-xs text-red-500 hover:text-red-700 underline">عرض الكل ({{ outOfStockItemsList.length }})</button></div>
              </div>
            ...
            <div class="flex justify-between items-start">
              <div class="flex-1">
                ...
                <table class="w-full mt-2 text-xs text-orange-600 dark:text-orange-400">
                  <thead><tr class="border-b border-orange-200 dark:border-orange-800"><th class="text-center py-1 px-2">الصنف</th><th class="text-center py-1 px-2">الكود</th><th class="text-center py-1 px-2">المخزن</th><th class="text-center py-1 px-2">اللون</th><th class="text-center py-1 px-2">الكمية</th></tr></thead>
                  <tbody>
                ...
                <div v-if="criticalStockLoadMore > 5" class="text-center mt-2"><button @click="criticalStockLoadMore = 5" class="text-xs text-orange-500 hover:text-orange-700 underline">عرض أقل</button></div>
                <div v-else-if="criticalStockItemsList.length > 5" class="text-center mt-2"><button @click="criticalStockLoadMore = criticalStockItemsList.length" class="text-xs text-orange-500 hover:text-orange-700 underline">عرض الكل ({{ criticalStockItemsList.length }})</button></div>
              </div>
            ...
            <div class="flex justify-between items-start">
              <div class="flex-1">
                ...
                <table class="w-full mt-2 text-xs text-yellow-600 dark:text-yellow-400">
                  <thead><tr class="border-b border-yellow-200 dark:border-yellow-800"><th class="text-center py-1 px-2">الصنف</th><th class="text-center py-1 px-2">الكود</th><th class="text-center py-1 px-2">المخزن</th><th class="text-center py-1 px-2">اللون</th><th class="text-center py-1 px-2">الكمية</th></tr></thead>
                  <tbody>
                ...
                <div v-if="lowStockLoadMore > 5" class="text-center mt-2"><button @click="lowStockLoadMore = 5" class="text-xs text-yellow-500 hover:text-yellow-700 underline">عرض أقل</button></div>
                <div v-else-if="lowStockItemsList.length > 5" class="text-center mt-2"><button @click="lowStockLoadMore = lowStockItemsList.length" class="text-xs text-yellow-500 hover:text-yellow-700 underline">عرض الكل ({{ lowStockItemsList.length }})</button></div>
              </div>
        ...
        <table class="w-full min-w-[600px]">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            <tr v-for="tx in recentTransactions" :key="tx.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
              ...
              <td class="px-4 sm:px-6 py-3 text-center"><span :class="getTypeBadge(tx.type)" class="px-2 py-1 text-sm rounded-full font-bold">{{ getTypeText(tx.type) }}</span></td>
