<template>
  <div :dir="languageStore.isRTL ? 'rtl' : 'ltr'" class="pb-32 sm:pb-20">
    <div class="max-w-7xl mx-auto">
      ...
      <div v-if="hasDraft && !isEdit && authStore.isFullyReady" class="mb-3 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-lg p-2.5 flex flex-col sm:flex-row justify-between items-center gap-2">
    ...
    <!-- Sticky Bottom Bar -->
    <div v-if="authStore.isFullyReady && (canCreateInvoice || canEditInvoice)" class="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-lg z-50 px-3 sm:px-4 py-3 sm:py-4" style="padding-bottom: env(safe-area-inset-bottom, 0.5rem);">
