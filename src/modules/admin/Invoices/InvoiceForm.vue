<template>
  <div :dir="languageStore.isRTL ? 'rtl' : 'ltr'" class="pb-32 sm:pb-20">
    <div class="max-w-7xl mx-auto">
      ...
      <!-- Loading State -->
      <div v-if="!authStore.isInitialized" class="flex items-center justify-center py-12">
      ...
      <!-- Permission Check -->
      <div v-if="!authStore.isFullyReady" class="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4 text-center">
        <p class="text-yellow-800 dark:text-yellow-300">جاري التحقق من الصلاحيات...</p>
      </div>

      <div v-else-if="!canEditInvoice && isEdit" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 sm:p-8 text-center border border-gray-200 dark:border-gray-700">
    ...
    <!-- Sticky Bottom Bar - Only show when user has permission -->
    <div v-if="canCreateInvoice || canEditInvoice" class="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-lg z-50 px-3 sm:px-4 py-3 sm:py-4" style="padding-bottom: env(safe-area-inset-bottom, 0.5rem);">
...
// ============================================================
// PERMISSIONS - Directly from authStore
// ============================================================
const canCreateInvoice = computed(() => {
  if (!authStore.isFullyReady) return false
...
// ============================================================
onActivated(() => {
  // When returning to this page, restore cache if form is empty
  if (!isEdit.value && form.items.length === 0 && !isCacheRestored && !isInitialLoad) {
    restoreFormFromCache()
  }
  
  // Refresh warehouse items if needed
...
// ============================================================
// FIXED: Multi-Warehouse Stock Validation
// ============================================================
