<template>
  <div :dir="languageStore.isRTL ? 'rtl' : 'ltr'" class="pb-32 sm:pb-20">
    ...
    <!-- Sticky Bottom Bar - ALWAYS VISIBLE (no permission checks - user already passed route guard) -->
...
// No permission checks needed here - route guard and InvoiceList already handle this
// The form only cares about form state
