...
function restoreListFromCache(): boolean {
  try {
    ...
    // Restore data
    invoiceStore.invoices = cache.invoices
    invoiceStore.totalInvoices = cache.totalInvoices
    invoiceStore.totalAmount = cache.totalAmount
    invoiceStore.pendingAmount = cache.pendingAmount
    invoiceStore.invoiceFilters = cache.filters
    invoiceStore.invoicePagination = cache.pagination
...
function clearListCache() {
  try {
    ...
    console.warn('Failed to clear invoice list cache:', e)
  }
}
