    ...
    <div style="direction: rtl; font-family: 'Cairo', Arial, sans-serif; padding: 40px; max-width: 1100px; margin: 0 auto; background: white;">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 30px;">
        <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 15px; background-color: #f9fafb;">
          ...
          <p style="margin: 4px 0; color: #4b5563; font-size: 13px;"><strong>${companyInfo.value.name}</strong></p>
          <p style="margin: 4px 0; color: #4b5563; font-size: 13px;">السجل الضريبي: ${companyInfo.value.taxNumber}</p>
          <p style="margin: 4px 0; color: #4b5563; font-size: 13px;">${companyInfo.value.address}</p>
          <p style="margin: 4px 0; color: #4b5563; font-size: 13px;">هاتف: ${companyInfo.value.phone}</p>
          <p style="margin: 4px 0; color: #4b5563; font-size: 13px;">البريد الإلكتروني: ${companyInfo.value.email}</p>
        </div>
