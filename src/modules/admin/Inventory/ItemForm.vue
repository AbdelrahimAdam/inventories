<template>
  <div :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
    ...
    <div v-if="authStore.isViewOnly" class="card-warm">
    ...
    <div v-else-if="authStore.isWarehouseManager && isEdit && !canEditCurrentItem" class="card-warm">
      <div class="bg-gradient-to-r from-red-600 to-red-700 dark:from-red-700 dark:to-red-800 px-3 sm:px-4 py-2.5 sm:py-3 -mx-3 sm:-mx-4 -mt-3 sm:-mt-4 rounded-t-xl">
            ...
            <div class="flex justify-end mb-2">
              <div class="flex gap-1 bg-white dark:bg-gray-800 rounded-lg p-0.5 shadow-sm border border-gray-200 dark:border-gray-600">
                <button
                  ...
                  :class="['px-3 py-1.5 rounded min-w-[44px] text-xs transition-all active:scale-95', inputMode === 'detailed' ? 'bg-gradient-to-r from-amber-600 to-amber-700 text-white shadow-md' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700']"
                >
                  تفصيلي
                </button>
                <button
                  ...
                  :class="['px-3 py-1.5 rounded min-w-[44px] text-xs transition-all active:scale-95', inputMode === 'simple' ? 'bg-gradient-to-r from-amber-600 to-amber-700 text-white shadow-md' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700']"
                >
                  بسيط
                </button>
              </div>
