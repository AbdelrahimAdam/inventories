  ...
  <div :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
    ...
    <div v-else class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200 overflow-hidden">
      ...
      <form @submit.prevent="handleSubmit" class="p-3 sm:p-4 space-y-4">
        <!-- Success Message - Sticky and visible -->
        <div v-if="successMessage || updateInfoMessage" class="sticky top-0 z-20 bg-white dark:bg-gray-800 pt-2 pb-1 -mt-1">
          <div v-if="successMessage" class="bg-green-50 dark:bg-green-900/20 border-2 border-green-300 dark:border-green-700 rounded-lg p-3 shadow-lg">
          ...
          <div v-if="updateInfoMessage" class="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-300 dark:border-blue-700 rounded-lg p-3 shadow-lg">
            <div class="flex items-center gap-2">
