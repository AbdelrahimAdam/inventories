            ...
            <div class="flex flex-wrap items-center gap-2">
              ...
              <div class="flex gap-1.5">
                <button
                  ...
                  :class="[
                    'px-3 py-1.5 text-xs sm:text-sm rounded-lg transition-all duration-200 min-w-[44px] active:scale-95',
                    itemType === 'carton' 
...
const saveItem = async () => {
  ...
  try {
    ...
    if (isEdit.value) {
      ...
      if (success) {
        const warehouseName = warehouseStore.warehouses.find(w => w.id === form.warehouseId)?.name_ar || form.warehouseId
