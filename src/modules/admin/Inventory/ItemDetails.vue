      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200 dark:divide-gray-700">
        ...
        <div class="p-3 sm:p-5 space-y-4">
          ...
          <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4">
            ...
            <div class="space-y-3">
              <div class="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                <span class="text-xs font-bold text-gray-500 dark:text-gray-400 min-w-[90px] uppercase tracking-wide">الاسم</span>
                <p class="text-sm sm:text-base font-black text-gray-900 dark:text-white break-words">{{ item.name }}</p>
              </div>
              <div class="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                <span class="text-xs font-bold text-gray-500 dark:text-gray-400 min-w-[90px] uppercase tracking-wide">الكود</span>
                <p class="text-sm sm:text-base font-mono font-black text-gray-900 dark:text-white">{{ item.code }}</p>
              </div>
              <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                <span class="text-xs font-bold text-gray-500 dark:text-gray-400 min-w-[90px] uppercase tracking-wide">اللون</span>
                <div class="flex items-center gap-2">
                  <div class="w-6 h-6 rounded-full border-2 border-gray-300 shadow-sm flex-shrink-0" :style="{ backgroundColor: item.color }"></div>
                  <span class="text-sm sm:text-base font-black text-gray-900 dark:text-white">{{ item.color || '—' }}</span>
                </div>
              </div>
              <div class="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                <span class="text-xs font-bold text-gray-500 dark:text-gray-400 min-w-[90px] uppercase tracking-wide">المقاس</span>
                <p class="text-sm sm:text-base"><span class="px-2 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-300 rounded-lg text-xs font-black inline-block">{{ item.size || '—' }}</span></p>
              </div>
              <div class="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                <span class="text-xs font-bold text-gray-500 dark:text-gray-400 min-w-[90px] uppercase tracking-wide">المخزن</span>
                <p class="text-sm sm:text-base font-black text-gray-900 dark:text-white">{{ getWarehouseName(item.warehouseId) }}</p>
              </div>
              <div class="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                <span class="text-xs font-bold text-gray-500 dark:text-gray-400 min-w-[90px] uppercase tracking-wide">المورد</span>
                <p class="text-sm sm:text-base font-black text-gray-900 dark:text-white">{{ item.supplier || '—' }}</p>
              </div>
            </div>
          </div>
          ...
          <div v-if="item.location || item.notes" class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4">
            ...
            <div class="space-y-3">
              <div v-if="item.location" class="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                <span class="text-xs font-bold text-gray-500 dark:text-gray-400 min-w-[90px] uppercase tracking-wide">الموقع</span>
                <p class="text-sm sm:text-base font-black text-gray-900 dark:text-white break-words">{{ item.location }}</p>
              </div>
              <div v-if="item.notes" class="flex flex-col gap-1">
                <span class="text-xs font-bold text-gray-500 dark:text-gray-400 min-w-[90px] uppercase tracking-wide">ملاحظات</span>
                <p class="text-xs sm:text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap bg-gray-100 dark:bg-gray-700/50 p-2 rounded-lg">{{ item.notes }}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <form @submit.prevent="handleUpdate" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <datalist id="size-options">
                      <option value="3ml"><option value="5ml"><option value="10ml"><option value="30ml"><option value="50ml"><option value="100ml">
                      <option value="XS"><option value="S"><option value="M"><option value="L"><option value="XL"><option value="XXL"><option value="XXXL">
                    </datalist>
                  </div>
                ...
                <div class="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-3">
                  <div class="flex justify-between items-center">
                    ...
                    <span class="text-xl font-black text-amber-700 dark:text-amber-400">{{ editTotalQuantity.toLocaleString() }} وحدة</span>
                  </div>
                </div>
                <div>
...
// ===== OPTIMIZED: Load item with cache-first approach =====
