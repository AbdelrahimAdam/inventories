<template>
  <div class="container mx-auto px-3 sm:px-4 py-4 sm:py-8" :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
    ...
    <!-- Items Table - Single Scroll Container (No double scrollbars) -->
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
      <div class="overflow-x-auto">
        <div class="overflow-y-auto" style="height: calc(100vh - 380px); min-height: 400px; scroll-behavior: smooth;">
...
// Filtered items - UPDATED STOCK LOGIC: ≤500 = Low Stock, ≤250 = Critical Stock
...
// Stats - UPDATED with new thresholds
