...
const onTransferSuccess = async () => { /* refresh handled by store */ }
const onDispatchSuccess = async () => { /* refresh handled by store */ }
const onTransactionSuccess = async () => { /* refresh handled by store */ }
