    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
      <div class="flex items-center gap-3">
        ...
        <button 
          ...
          class="p-2 text-amber-600 hover:text-amber-700 dark:text-amber-400 dark:hover:text-amber-300 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-xl transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
          title="تحديث المخزون"
...
// NEW: Force refresh inventory from server
async function refreshInventory() {
  ...
  try {
    // Clear all caches
    inventoryStore.clearSearchResults()
    inventoryStore.filterCache.clear()
