  ...
  <div :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
    ...
    <div v-if="viewMode === 'paginated' && filteredItems.length > pageSize" class="pagination-container">
      ...
      <div class="flex gap-1.5 order-1 sm:order-3">
        <button @click="goToFirstPage" :disabled="currentPage === 1" class="px-2.5 py-1 border border-gray-300 dark:border-gray-600 rounded-xl disabled:opacity-50 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-xs font-semibold min-h-[44px]">««</button>
        ...
        <button @click="goToLastPage" :disabled="currentPage === totalPages" class="px-2.5 py-1 border border-gray-300 dark:border-gray-600 rounded-xl disabled:opacity-50 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-xs font-semibold min-h-[44px]">»»</button>
      </div>
    </div>
