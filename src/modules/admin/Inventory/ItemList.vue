  ...
  <div :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-3">
      <div class="text-sm font-semibold text-gray-600 dark:text-gray-400">
        ...
        <span v-if="filteredItems.length < totalCount" class="text-amber-600 dark:text-amber-400">
          (تم تصفية {{ formatNumber(totalCount - filteredItems.length) }} صنف)
        </span>
      </div>
...
const totalCount = computed(() => inventoryStore.totalCount || inventoryStore.items.length)
