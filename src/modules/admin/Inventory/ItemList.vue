...
// ✅ Load inventory using store's cache-aware fetchItems()
async function loadInventory() {
  ...
  try {
    ...
    // ✅ fetchItems() handles cache checking internally
...
// ✅ Updated delete - only refresh stats, not full reload
async function deleteItem() {
  ...
  try {
    ...
    if (success) {
      ...
      // ✅ Only refresh summary stats after delete
...
// ✅ Success handlers - only refresh specific items and stats
