<template>
  <div :dir="languageStore.isRTL ? 'rtl' : 'ltr'">
              ...
              <template v-else>
                <tr v-for="item in displayItems" :key="item.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  ...
                  <td class="px-3 py-3 text-center align-middle w-24">
                    <div class="action-menu-container relative inline-block" ref="actionMenuRefs">
                      <button 
    ...
    <!-- Teleported Dropdown - FIXED with proper positioning -->
    <Teleport to="body">
      <div 
...
let dropdownPositionTimer: ReturnType<typeof setTimeout> | null = null
...
// ============================================================
// DROPDOWN POSITIONING - COMPLETELY REWRITTEN
// ============================================================
...
const positionDropdown = (buttonRect: DOMRect) => {
  ...
  // Determine if dropdown fits below or above
  if (spaceBelow >= dropdownHeight) {
    ...
    // Doesn't fit either - use the side with more space
...
const recalculateDropdownPosition = () => {
  ...
  // Find the button that opened this dropdown
  ...
  for (const btn of buttons) {
    if (btn.closest('.action-menu-container')) {
      ...
      if (parent) {
        // Check if this button's item matches the active action menu
