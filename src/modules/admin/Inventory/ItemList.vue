...
// ============================================================
// CRITICAL PERFORMANCE FIX: onActivated now uses cache
// ============================================================
onActivated(async () => {
  // If we already have data, just show it
  if (inventoryStore.items.length > 0 && !inventoryStore.isLoading) {
    // Only refresh if user explicitly wants to (force refresh)
...
// ============================================================
// CRITICAL PERFORMANCE FIX: onMounted now uses cache
// ============================================================
onMounted(async () => {
