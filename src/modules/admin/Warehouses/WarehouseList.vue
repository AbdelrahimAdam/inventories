        ...
        <div class="card-content">
          ...
          <div class="card-meta">
            <div class="meta-item">
              ...
              <span>{{ formatDate(warehouse.created_at || warehouse.createdAt) }}</span>
            </div>
...
// FIXED: Proper interface extending with Omit to avoid is_main conflict
interface WarehouseExtended extends Omit<Warehouse, 'is_main'> {
  name_ar?: string
  name_en?: string
  location?: string
  description?: string
  ...
  createdAt?: string | Date // For backward compatibility
}
...
// FIXED: Properly typed filtered warehouses with all required properties
const filteredWarehouses = computed((): WarehouseExtended[] => {
  ...
  return warehouses.map((w: any) => ({
    ...
    updated_at: w.updated_at || w.updatedAt || new Date().toISOString(),
...
// FIXED: Format date with proper handling of both created_at and createdAt
