      ...
      >
        ...
        <div class="card-content">
          ...
          <div class="card-meta">
            ...
            <div v-if="warehouse.itemCount !== undefined" class="meta-item">
              <svg class="meta-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// Use the Warehouse type directly from the store
// No need for a separate extended interface since the store already has all properties
...
const canManageWarehouses = computed(() => {
  return authStore.canManageWarehouses
})
...
const filteredWarehouses = computed((): WarehouseExtended[] => {
  ...
  // Use the store's computed properties for filtering by permissions
