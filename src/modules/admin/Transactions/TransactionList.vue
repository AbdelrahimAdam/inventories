    ...
    <div v-else>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-3 sm:p-4 hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
          ...
          <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ formatNumber(filteredTransactions.length) }}</p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-3 sm:p-4 hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-700">
      ...
      <div class="lg:hidden space-y-3">
        ...
        <div v-if="filteredTransactions.length === 0" class="text-center py-12 text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 rounded-lg border">
          لا توجد حركات
        </div>
      </div>
