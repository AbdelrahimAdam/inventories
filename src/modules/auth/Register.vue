  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-200 to-green-100 py-12 px-4 sm:px-6 lg:px-8 relative">
    ...
    <div class="bg-white border border-amber-100 rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-2xl relative">
      ...
      <div class="text-center mb-6 sm:mb-8">
        ...
        <p class="text-gray-500 mt-2 text-sm sm:text-base">ابدأ تجربتك المجانية – 14 يوماً بصلاحيات كاملة</p>
      </div>
      ...
      <form class="mt-6 sm:mt-8 space-y-4 sm:space-y-6" @submit.prevent="handleSubmit">
        ...
        <div class="bg-amber-50 rounded-xl p-3 sm:p-4 border border-amber-200">
          <div class="flex items-center gap-2 mb-3">
            ...
            <h2 class="text-base sm:text-lg font-bold text-gray-800">البيانات الأساسية للشركة</h2>
          </div>
          ...
          <div class="mb-3 sm:mb-4">
            ...
            <input
              ...
              type="text"
              required
              class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition text-right"
        ...
        <div class="bg-gray-50 rounded-xl p-3 sm:p-4 border border-gray-200">
          <div class="flex items-center gap-2 mb-3">
            ...
            <h2 class="text-base sm:text-lg font-bold text-gray-800">بيانات الحساب</h2>
          </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <button
                  ...
                  class="absolute left-3 top-2.5 text-gray-500 hover:text-amber-700 text-sm font-medium"
                >
