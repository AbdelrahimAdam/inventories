<template>
  <div 
    class="login-container min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 sm:px-6 lg:px-8 relative overflow-hidden" 
  ...
  >
    ...
    <div class="login-card bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border border-gray-300 dark:border-gray-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 p-6 sm:p-8 w-full max-w-md">
      <div class="text-center mb-6">
        ...
        <h1 class="brand-title text-2xl sm:text-3xl font-extrabold tracking-wide bg-gradient-to-r from-amber-600 to-amber-700 bg-clip-text text-transparent">
          P.commerce
        </h1>
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        <div>
          ...
          <div class="relative">
            <input
              type="email"
              v-model="email"
              class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition bg-white/90 dark:bg-gray-700/90 text-gray-900 dark:text-white hover:border-amber-300 dark:hover:border-amber-700"
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <router-link
            to="/forgot-password"
            class="text-sm text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 font-medium hover:underline"
          >
        ...
        <button
          ...
          class="w-full bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white py-2.5 rounded-xl font-semibold transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center border border-amber-500/20"
        >
        ...
        <!-- Error Message -->
        <div v-if="authStore.error" class="p-3 bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-700 rounded-lg shadow-sm">
      ...
      <div class="mt-6 space-y-2">
        <p class="text-sm text-gray-500 dark:text-gray-400 text-center">
          ...
          <router-link to="/register" class="text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 font-medium hover:underline">
...
const preloadDataAfterLogin = async () => {
  try {
    ...
    console.log('🔄 Preloading inventory data after login...')
    ...
    console.log('✅ Inventory data preloaded successfully')
  } catch (error) {
