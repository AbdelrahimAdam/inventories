  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-200 to-green-100 py-12 px-4 sm:px-6 lg:px-8 relative">
    ...
    <div class="bg-white border border-amber-100 rounded-2xl shadow-2xl p-6 sm:p-8 w-full max-w-md hover:shadow-3xl transition-shadow duration-300">
      ...
      <div class="text-center mb-6 sm:mb-8">
        ...
        <h1 class="text-2xl sm:text-3xl font-extrabold tracking-wide bg-gradient-to-r from-amber-600 to-green-600 bg-clip-text text-transparent">
          P.commerce
        </h1>
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6">
          <label class="flex items-center cursor-pointer">
            <input
              type="checkbox"
              v-model="rememberMe"
              class="ml-2 rounded border-gray-300 text-amber-600 focus:ring-amber-500 cursor-pointer w-4 h-4"
            />
