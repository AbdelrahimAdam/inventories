<template>
  ...
  >
    ...
    <button 
      ...
      class="absolute top-4 left-4 sm:top-6 sm:left-6 text-gray-600 dark:text-gray-400 hover:text-amber-600 dark:hover:text-amber-400 transition-colors duration-200 p-2 rounded-full hover:bg-white/50 dark:hover:bg-gray-700/50 z-10 text-sm font-medium"
    >
