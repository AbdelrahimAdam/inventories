...
export const useAuthStore = defineStore('auth', () => {
  ...
  // ✅ NEW: Handler for subscription restored event
  ...
  // ✅ NEW: Set up subscription listeners
  function setupSubscriptionListeners(): void {
    // Listen for subscription restored events from Supabase service
  ...
  async function initialize(): Promise<boolean> {
    ...
    initPromise = (async () => {
      try {
        // ✅ Set up subscription listeners on initialization
  ...
  async function login(credentials: LoginCredentials): Promise<boolean> {
    ...
    try {
      ...
      // ✅ Ensure subscription listeners are set up after login
      setupSubscriptionListeners()
  ...
  return {
    ...
    // ✅ Export the setup function for external use if needed
    setupSubscriptionListeners,
