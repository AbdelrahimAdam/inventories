...
export const useInventoryStore = defineStore('inventory', () => {
  ...
  // ✅ Restore all persisted state on store creation
  ...
  watch(
    ...
    (tenantId) => {
      ...
      if (tenantId) {
        ...
        // ✅ Restore state on tenant change
        restorePersistedState(tenantId)
  ...
  // ✅ Initialize: Restore state from cache on store creation
