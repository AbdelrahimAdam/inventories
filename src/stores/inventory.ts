// stores/inventory.ts - Full updated version with the fix
...
export const useInventoryStore = defineStore('inventory', () => {
  ...
  // ✅ FIXED: Watch with duplicate load prevention
  watch(
