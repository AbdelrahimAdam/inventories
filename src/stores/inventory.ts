...
export const useInventoryStore = defineStore('inventory', () => {
  ...
  // ============================================
  // ✅ FIXED: loadFromCache - Only FULL load is complete
  // ============================================
  ...
  // ============================================
  // ✅ UPDATED: fetchItemsPage - Server-side pagination
  // ============================================
  async function fetchItemsPage(params: {
    ...
    // If requesting a large page size, treat as "load all"
    if (pgSize >= 10000) {
    ...
    try {
      ...
      // Save paginated cache (will NOT be marked complete)
  ...
  // ============================================
  // ✅ PRESERVED: fetchItems - Load all items (used for "View All" and export)
  // ============================================
  ...
  // ============================================
  // ✅ UPDATED: forceRefreshAll - Load first page only
  // ============================================
  ...
  // ============================================
  // ✅ UPDATED: WATCHES - Load first page on tenant change
  // ============================================
  watch(
