...
export const useInventoryStore = defineStore('inventory', () => {
  ...
  async function hybridSearch(searchQuery: string) {
    ...
    // ✅ STEP 1: Search in allItemsForStats (ALL cached items) - FASTEST
    ...
    // ✅ STEP 2: Search in current page items (fast fallback)
    ...
    // ✅ STEP 3: Only hit database if no results in cache
