...
export const useInventoryStore = defineStore('inventory', () => {
  ...
  // ✅ Global stats from all loaded items - computed reactive
  ...
  async function fetchItemsPage(params: {
    ...
    // ✅ On first load, force fresh data - skip cache
  ...
  // ✅ fetchItems always loads fresh data on first call
  async function fetchItems(): Promise<void> {
    // ✅ Always load fresh data with a very large page size
    await fetchItemsPage({ page: 1, pageSize: 100000, force: true })
  }
