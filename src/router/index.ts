...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/super-admin/requests', name: 'super-admin-requests', component: () => import('@/modules/super-admin/UpgradeRequests.vue'), meta: { requiresAuth: true, roles: ['superadmin'] } },
    { path: '/super-admin/settings', name: 'super-admin-settings', component: () => import('@/modules/super-admin/SystemSettings.vue'), meta: { requiresAuth: true, roles: ['superadmin'] } },
