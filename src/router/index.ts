...
const router = createRouter({
  ...
  routes: [
    ...
    { 
      ...
      meta: { requiresAuth: true, roles: ['company_manager'], title: 'لوحة تحكم المدير' } 
    },
    { 
      path: '/admin/users', 
    ...
    { 
      ...
      meta: { requiresAuth: true, roles: ['company_manager', 'warehouse_manager', 'viewer'], title: 'الأصناف' } 
    },
    { 
    ...
    { 
      ...
      meta: { requiresAuth: true, roles: ['company_manager', 'warehouse_manager'], title: 'الفواتير' } 
    },
    { 
      path: '/invoices/new', 
      name: 'invoice-new', 
    ...
    { 
      ...
      meta: { requiresAuth: true, roles: ['warehouse_manager'], title: 'لوحة تحكم مدير المستودع' } 
    },
    { 
      path: '/viewer/dashboard', 
      name: 'viewer-dashboard', 
      component: () => import('@/modules/viewer/Dashboard.vue'), 
      meta: { requiresAuth: true, roles: ['viewer'], title: 'لوحة تحكم المشاهد' } 
    },
    ...
    { 
      ...
      meta: { requiresAuth: true, roles: ['superadmin'], title: 'لوحة تحكم المشرف العام' } 
    },
    { 
    ...
    { 
      ...
      component: () => import('@/modules/super-admin/UpgradeRequests.vue'), 
      meta: { requiresAuth: true, roles: ['superadmin'], title: 'طلبات الترقية' } 
    },
    { 
      path: '/super-admin/settings', 
      name: 'super-admin-settings', 
      component: () => import('@/modules/super-admin/SystemSettings.vue'), 
...
router.beforeEach(async (to: RouteLocationNormalized, _from: RouteLocationNormalized, next: NavigationGuardNext) => {
  ...
  // Skip expiration checks for superadmin
  ...
  if (isAuthenticated && publicPaths.includes(to.path)) {
    // Superadmin bypasses expiration checks
    if (!isSuperAdmin) {
