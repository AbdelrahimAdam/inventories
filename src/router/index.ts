...
// ✅ Fixed: Remove prefetch logic that causes TypeScript errors
// Prefetching is handled by Vite's dynamic imports with webpackChunkName
// No need for additional prefetch logic
