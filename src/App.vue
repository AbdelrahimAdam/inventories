  ...
  <template v-else>
    ...
    >
      ...
      <div class="content-area">
        ...
        <div v-if="!isInvoiceFormRoute" class="bottom-nav-wrapper">
...
// ✅ Add logging out flag to prevent loading spinner during logout
const isLoggingOut = ref(false)

// ✅ Compute route key for keep-alive
const routeKey = computed(() => {
  return authStore.user?.id || route.path
})

// ✅ List of components to keep alive
...
// ✅ Updated handleLogout with isLoggingOut flag
