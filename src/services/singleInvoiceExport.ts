...
export class SingleInvoiceExportService {
  ...
  private static createProfessionalInvoiceWorksheet(
    ...
    const primaryColor = 'FF4A7BB7'
    const secondaryColor = 'FFD4E2F0'
    ...
    const thickBorder: Partial<ExcelJS.Borders> = {
      top: { style: 'thick', color: { argb: primaryColor } },
      left: { style: 'thick', color: { argb: primaryColor } },
      bottom: { style: 'thick', color: { argb: primaryColor } },
      right: { style: 'thick', color: { argb: primaryColor } }
    }
    ...
    if (logoImageId !== null) {
      try {
        ...
        console.warn('Failed to add logo to worksheet:', e)
    ...
    sigCell1.border = { top: { style: 'thin', color: { argb: 'FF999999' } } }
    ...
    sigCell4.border = { top: { style: 'thin', color: { argb: 'FF999999' } } }
